...
<div class="card">
    <div class="card-body">
        <h3 class="card-title mb-0">{lang key="navUserManagement"}</h3>

        <p class="coodiv-text-11">{lang key="userManagement.usersFound" count=$users->count()}</p>
        ...
        <p class="text-muted m-0 coodiv-text-11 font-weight-light">* {lang key="userManagement.accountOwnerPermissionsInfo"}</p>
